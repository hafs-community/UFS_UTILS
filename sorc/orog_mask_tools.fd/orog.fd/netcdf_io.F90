...
!! @author Jordan Alpert NOAA/EMC GFDL Programmer
  subroutine write_netcdf(im, jm, slm, land_frac, oro, orf, hprime, ntiles, tile, geolon, geolat, lon, lat)
    ...
    !--- define field 
!---geolon
    error = nf_def_var(ncid, 'geolon', NF_FLOAT, 2, vdims, id_geolon)
...
!---geolat
    error = nf_def_var(ncid, 'geolat', NF_FLOAT, 2, vdims, id_geolat)
...
!---slmsk
    error = nf_def_var(ncid, 'slmsk', NF_FLOAT, 2, vdims, id_slmsk)
...
!--- land_frac
    error = nf_def_var(ncid, 'land_frac', NF_FLOAT, 2, vdims, id_land_frac)
...
!---orography - raw
    error = nf_def_var(ncid, 'orog_raw', NF_FLOAT, 2, vdims, id_orog_raw)
...
!---orography - filtered
    error = nf_def_var(ncid, 'orog_filt', NF_FLOAT, 2, vdims, id_orog_filt)
...
!---stddev
    error = nf_def_var(ncid, 'stddev', NF_FLOAT, 2, vdims, id_stddev)
...
!---convexity
    error = nf_def_var(ncid, 'convexity', NF_FLOAT, 2, vdims, id_convex)
...
!---oa1 -> oa4
    error = nf_def_var(ncid, 'oa1', NF_FLOAT, 2, vdims, id_oa1)
    ...
    error = nf_def_var(ncid, 'oa2', NF_FLOAT, 2, vdims, id_oa2)
    ...
    error = nf_def_var(ncid, 'oa3', NF_FLOAT, 2, vdims, id_oa3)
    ...
    error = nf_def_var(ncid, 'oa4', NF_FLOAT, 2, vdims, id_oa4)
...
!---ol1 -> ol4
    error = nf_def_var(ncid, 'ol1', NF_FLOAT, 2, vdims, id_ol1)
    ...
    error = nf_def_var(ncid, 'ol2', NF_FLOAT, 2, vdims, id_ol2)
    ...
    error = nf_def_var(ncid, 'ol3', NF_FLOAT, 2, vdims, id_ol3)
    ...
    error = nf_def_var(ncid, 'ol4', NF_FLOAT, 2, vdims, id_ol4)
...
!---theta gamma sigma elvmax
    error = nf_def_var(ncid, 'theta', NF_FLOAT, 2, vdims, id_theta)
    ...
    error = nf_def_var(ncid, 'gamma', NF_FLOAT, 2, vdims, id_gamma)
    ...
    error = nf_def_var(ncid, 'sigma', NF_FLOAT, 2, vdims, id_sigma)
    ...
    error = nf_def_var(ncid, 'elvmax', NF_FLOAT, 2, vdims, id_elvmax)
